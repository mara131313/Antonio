...
4. LEGS: movement is made with tank tracksusing dc motors.
...
Intelligence lives in the robot, taking actions based on the remotes input
...
This is not just a tutorial because we are making our own designs for the robot's design and movement, our own interface for the remote, and our own unique interactions. This tutorial would have to include days worth of footage to encase the steps.
